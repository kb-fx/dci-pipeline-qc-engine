...
* **Bandwidth Limit Verification:** Calculates exact Megabits-per-second (Mbps) using raw byte size and duration to ensure the JPEG2000 codestream stays strictly beneath the 250 Mbps hardware ceiling, preventing theatre projector crashes.
